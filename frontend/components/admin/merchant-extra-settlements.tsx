...
export function MerchantExtraSettlements({ merchantId }: MerchantExtraSettlementsProps) {
  ...
  const getReasonBadge = (reason: string) => {
    switch (reason) {
      case 'manual':
        return <Badge variant="default">Ручной</Badge>
      case 'auto':
        return <Badge variant="secondary">Автоматический</Badge>
      default:
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Сводка по дополнительным расчетам</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg">История расчетов</CardTitle>
            <Button
              variant="outline"
              size="icon"
