        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 items-center">
            ...
            {rapiraKkk && currentRapiraRate && (
              <div className="flex-1 min-w-[200px] p-3 bg-gradient-to-r from-green-50 to-green-100/50 dark:from-green-900/20 dark:to-green-800/10 rounded-lg border-2 border-green-500 dark:border-green-600">
                <p className="text-sm font-medium text-gray-900 dark:text-gray-200">
                  Новый курс: <span className="text-lg font-bold text-green-600 dark:text-green-400">
