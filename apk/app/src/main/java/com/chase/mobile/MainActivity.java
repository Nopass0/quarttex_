...
import com.chase.mobile.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkNotificationAccess() {
        ComponentName cn = new ComponentName(this, com.chase.mobile.services.NotificationListenerService.class);
