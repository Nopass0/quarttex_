...
const services = [
  ...
  { name: 'TestMerchantMockService', displayName: 'Test Merchant Mock Service', description: 'Mock service for testing merchant functionality', enabled: true },
  { name: 'ExampleService', displayName: 'Example Service', description: 'Example background service', enabled: true },
  { name: 'AdvancedExampleService', displayName: 'Advanced Example Service', description: 'Advanced example background service', enabled: true },
  { name: 'TelegramService', displayName: 'Telegram Service', description: 'Telegram bot integration', enabled: false },
  { name: 'MerchantEmulatorService', displayName: 'Merchant Emulator Service', description: 'Emulates merchant transactions for testing', enabled: true },
